...
//		}
	...
	public Repository deployModelVersion(long versionId, String repositoryName) throws RepositoryException {
		...
		try {
			...
			Map<String, String> models = null;//modelSchemaGenerator.generateSchema(version);
			String token = UUID.randomUUID().toString();
			String repositoryUrl = null;//deployer.deployRepository(Deployer.RepositoryType.Mongo, repositoryName, models, token);
