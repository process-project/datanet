...
public interface RepositoryServiceAsync {
	...
	void getData(long repositoryId, String entityName, int start, int length, Map<String, String> query, String login, String password, AsyncCallback<EntityData> asyncCallback);
